...
class MySQLConnectorTest {
    ...
    void testAllOperation() {
        ...
        assertThrows(RuntimeException.class, ()->{connector.executeQuery("SELECT 1 FROM non_exist_database");});
        assertThrows(RuntimeException.class, ()->{connector.executeUpdate("INSERT INTO non_exist_database (CustomerName, ContactName, Address, City, PostalCode, Country)\n" +
