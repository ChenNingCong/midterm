...
class AdminMySQLTransactionManagerTest {
    ...
    void testAllOperation() {
        ...
        assertThrows(InvalidAccountIdException.class, ()->{
            manager.updateAccount(3, account3.login, account3.pinCode, account3.holdersName, account3.status);
        });
        assertDoesNotThrow(()->{
            manager.updateAccount(2, account3.login, account3.pinCode, account3.holdersName, account3.status);
        });
        assertDoesNotThrow(()->{
