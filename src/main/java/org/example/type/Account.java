...
public class Account {
    ...
    public Account(Integer id, String login, String pinCode, String holdersName, Integer balance, Boolean status) {
        this.id = id;
        this.login = login;
    ...
    public Account(String login, String pinCode, String holdersName, Integer balance, Boolean status) {
        this.id = -1;
        this.login = login;
        this.pinCode = pinCode;
        this.holdersName = holdersName;
